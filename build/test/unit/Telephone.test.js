...
describe('Telephone Value Object', () => {
    ...
    describe('validation', () => {
        ...
        it('should throw error when number is negative', () => {
            expect(() => Telephone.create(-12345678, 11)).toThrow('Phone number must be a positive integer');
        });
        ...
        it('should throw error when number has more than 9 digits', () => {
            expect(() => Telephone.create(1234567890, 11)).toThrow('Phone number must have exactly 8 or 9 digits');
        });
        it('should throw error when area code is not an integer', () => {
            expect(() => Telephone.create(12345678, 11.5)).toThrow('Area code must be a positive integer');
        });
        it('should throw error when area code is negative', () => {
            expect(() => Telephone.create(12345678, -11)).toThrow('Area code must be a positive integer');
        });
        it('should throw error when area code is zero', () => {
            expect(() => Telephone.create(12345678, 0)).toThrow('Area code must be a positive integer');
        });
        it('should throw error when area code has less than 2 digits', () => {
            expect(() => Telephone.create(12345678, 1)).toThrow('Area code must have exactly 2 digits');
        });
        it('should throw error when area code has more than 2 digits', () => {
            expect(() => Telephone.create(12345678, 111)).toThrow('Area code must have exactly 2 digits');
        });
    });
});
