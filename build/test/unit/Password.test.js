...
describe('Password Value Object', () => {
    ...
    test.each(['12345', 'abc', 'a', '12'])('should throw error for password with less than 6 characters: %s', (shortPassword) => {
        expect(() => Password.create(shortPassword)).toThrow('Password must have at least 6 characters');
    });
    test.each(['123456', '1234567', 'verylongpassword123', 'P@ssw0rd!'])('should accept valid password: %s', (validPassword) => {
